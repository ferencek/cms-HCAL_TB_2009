...
private:
  void preDrawTH1 ( TCanvas *, const DQMNet::CoreObject &o )
    {
      ...
      if (o.name.find("H2BeamLineMonitor/Event_Position_Monitor") !=std::string::npos)
      {
        if ((o.name.find("_XHits") !=std::string::npos) ||
            (o.name.find("_YHits") !=std::string::npos))
        {
          gStyle->SetOptStat(1111);
          obj->SetStats(kTRUE);
        }   
      }
      if ((o.name.find("H2BeamLineMonitor/QADC_Monitor") !=std::string::npos) ||
          (o.name.find("H2BeamLineMonitor/TOF_TDCs_and_Timing") !=std::string::npos) ||
          (o.name.find("H2RecHitMonitor") !=std::string::npos) ||
          (o.name.find("H2PedestalMonitor") !=std::string::npos))
      {
        gStyle->SetOptStat(11111111);
        obj->SetStats(kTRUE);
      }
      if (o.name.find("H2BeamLineMonitor/Wire_Chamber_Efficiency") !=std::string::npos)
      {
        obj->GetYaxis()->SetRangeUser(-0.05,1.05);
        obj->SetOption("hist");
      }
    }
  ...
  void preDrawTH2 ( TCanvas *c, const DQMNet::CoreObject &o )
	...
	gPad->SetGridy();
      ...
      else if ((o.name.find("H2BeamLineMonitor/Event_Position_Monitor") != std::string::npos) &&
               (o.name.find("_Hits") != std::string::npos))
      {
      	gPad->SetGridx();
	gPad->SetGridy();
        gStyle->SetPalette(1);
      ...
      else if ((o.name.find("H2RecHitMonitor") != std::string::npos) ||
               (o.name.find("H2PedestalMonitor") != std::string::npos))
      {
        gStyle->SetPalette(1);
